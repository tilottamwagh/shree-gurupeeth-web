...
export default function Home(){
 const [view,setView]=useState("home"),[entries,setEntries]=useState<Entry[]>([]),[aartiGroups,setAartiGroups]=useState<AartiGroup[]>([]),[selected,setSelected]=useState<Entry|null>(null),[loading,setLoading]=useState(false),[open,setOpen]=useState(false),[menuOpen,setMenuOpen]=useState(false),[count,setCount]=useState(0);
 useEffect(()=>{
