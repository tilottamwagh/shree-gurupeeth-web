...
export default function Home(){
 ...
 function openService(id:string){setMenuOpen(false);if(id==="jap")setOpen(true);else setView(id)}
 const info=remoteInfo[view];
 return <main className="shell">
  <header><button className="menu-trigger" aria-label={"\u092e\u0947\u0928\u0942"} aria-expanded={menuOpen} onClick={()=>setMenuOpen(true)}>☰</button><div className="brand"><Image unoptimized src="/app-assets/ic_launcher.png" alt="" width={42} height={42}/><div><b>श्री गुरुपीठ</b><small>दिंडोरी प्रणीत सेवा मार्ग</small></div></div><button className="lang">मराठी</button></header>
