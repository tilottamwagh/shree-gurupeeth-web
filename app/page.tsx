...
export default function Home(){
 ...
 return <main className="shell">
  ...
  {view==="calendar"&&<section className="page panchang-page"><button className="back" onClick={()=>setView("home")}>← मुख्यपृष्ठ</button><DailyPanchang/></section>}
