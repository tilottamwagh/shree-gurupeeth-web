...
export default function Home(){
 ...
 return <main className="shell">
  <header><button aria-label="Menu">☰</button><div className="brand"><Image unoptimized src="/app-assets/ic_launcher.png" alt="" width={42} height={42}/><div><b>श्री गुरुपीठ</b><small>दिंडोरी प्रणीत सेवा मार्ग</small></div></div><button className="lang">मराठी⌄</button></header>
